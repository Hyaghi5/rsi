...
function CheckAuthentication()
{
    ...
    //session_start();
    return isset($_SESSION['CK_Is_Authorized']) && $_SESSION['CK_Is_Authorized'];
...
$config['LicenseKey']  = 'C7WPJCY9CH983';
...
session_start();
//$baseUrl = 'http://localhost/sncmaindev/uploads/';
$baseUrl = $_SESSION['CK_Upload_BaseUrl'];
